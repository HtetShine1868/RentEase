...
@section('subtitle', 'Update laundry item details')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('laundry-provider.items.update', $item->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Optional description or notes">{{ old('description', $item->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="base_price" id="base_price" value="{{ old('base_price', $item->base_price) }}" required
                                   step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="rush_surcharge_percent" id="rush_surcharge_percent" 
                                   value="{{ old('rush_surcharge_percent', $item->rush_surcharge_percent) }}"
