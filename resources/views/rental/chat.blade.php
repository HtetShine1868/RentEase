    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Chat with Owner</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center">
                    @php
                        $otherParticipant = auth()->id() === $booking->user_id 
                            ? $booking->property->owner 
                            : $booking->user;
                    @endphp
                    
                    <!-- Avatar -->
                    <div class="h-12 w-12 rounded-full bg-gradient-to-r from-indigo-500 to-blue-500 flex items-center justify-center text-white font-bold text-lg">
                        @if($otherParticipant->avatar_url)
                            <img src="{{ $otherParticipant->avatar_url }}" alt="Avatar" class="h-12 w-12 rounded-full object-cover">
                        @else
            ...
            <div class="h-96 overflow-y-auto p-6 bg-gray-50" id="messagesContainer">
                @foreach($messages as $message)
                    @include('rental.partials.message', ['message' => $message])
                @endforeach
            </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-white">
                <form id="messageForm" class="flex space-x-3">
                    ...
                    <input type="text" 
                           ...
                           autocomplete="off">
                    <button type="submit" 
                            class="px-6 py-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-lg hover:from-indigo-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150 flex items-center">
