                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-2 mb-4">
                                    ...
                                    @if($booking->room)
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="font-medium">{{ $booking->room->room_type_name }} ({{ $booking->room->room_number }})</span>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="space-y-2">
                                    @if($booking->status === 'CONFIRMED')
                                        <form method="POST" action="{{ route('rental.booking.check-in', $booking) }}">
                                            @csrf
                                            <button type="submit" 
                                    ...
                                    @if($booking->status === 'CHECKED_IN')
                                        <form method="POST" action="{{ route('rental.booking.check-out', $booking) }}">
                                            @csrf
                                            <button type="submit" 
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button type="button" 
                                                onclick="openComplaintModal({{ $booking->id }})"
                                                class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-red-300 text-sm font-medium rounded-md text-red-700 bg-white hover:bg-red-50">
                                            Issue
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="px-6 py-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="ml-4 flex flex-col items-end space-y-2">
                                            ...
                                            <!-- Review Button -->
                                            @if($booking->status === 'CHECKED_OUT' && !$booking->property->reviews->where('user_id', Auth::id())->count())
                                                <button type="button"
                                ...
                                <div class="px-6 py-4">
                                    <div class="flex items-start justify-between">
                                        ...
                                        @if($complaint->property)
                                            <a href="{{ route('rental.property.details', $complaint->property) }}" 
...
function openComplaintModal(bookingId) {
    document.getElementById('complaintForm').action = `/rental/booking/${bookingId}/complaint`;
...
function openReviewModal(bookingId, propertyName) {
    ...
    document.getElementById('reviewForm').action = `/rental/booking/${bookingId}/review`;
