                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @php
                                    ...
                                    $isVegetarian = in_array('vegetarian', $dietaryTags);
...
<script>
    function showDeleteConfirmation(itemId, itemName) {
        ...
        const modal = document.getElementById('delete-menu-item-modal');
        if (modal) {
            ...
            // Show modal
            openModal('delete-menu-item-modal');
        }
    }
    ...
    // Helper function to open modal (if you have one)
