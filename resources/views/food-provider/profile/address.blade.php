...
<div class="space-y-6">
    ...
    @php
        ...
        $businessLocation = [
            ...
            'latitude' => $serviceProvider->latitude ?? 23.8103,
            'longitude' => $serviceProvider->longitude ?? 90.4125,
...
<script>
    ...
    function updateBusinessLocationFromCoords(lat, lng) {
        ...
        fetch('/food-provider/profile/reverse-geocode', {
            method: 'POST',
            headers: {
    ...
    function updateBusinessLocation(event) {
        ...
        fetch('/food-provider/profile/business-location', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
                'Accept': 'application/json'
    ...
    function searchLocation() {
        ...
        fetch('/food-provider/profile/geocode', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
        ...
        .then(data => {
            if (data.success && data.results && data.results.length > 0) {
                ...
                document.getElementById('address_line1').value = result.display_name.split(',')[0];
            } else {
    ...
    function editAddress(id) {
        ...
        fetch(`/food-provider/profile/address/${id}`, {
            headers: {
                'Accept': 'application/json',
    ...
    function setDefaultAddress(id) {
        fetch(`/food-provider/profile/address/${id}/default`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '{{ csrf_token() }}',
                'Accept': 'application/json'
    ...
    document.getElementById('addressForm').addEventListener('submit', function(e) {
        ...
        let url = '/food-provider/profile/address';
        
        if (addressId) {
            url = `/food-provider/profile/address/${addressId}`;
        }
