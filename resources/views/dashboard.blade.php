...
<head>
    ...
    <title>{{ config('app.name', 'RMS') }} - Dashboard</title>
                            ...
                            <div class="flex space-x-4">
                                ...
                                @auth
                                    @if(auth()->user()->isOwner())
                                        <a href="{{ route('owner.properties.index') }}" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                                            My Properties
                                        </a>
                                    @endif
                                    
                                    @if(auth()->user()->isFoodProvider())
                                        <a href="{{ route('food.orders') }}" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                                            Food Orders
                                        </a>
                                    @endif
                                    
                                    @if(auth()->user()->isLaundryProvider())
                                        <a href="{{ route('laundry.orders') }}" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
                                            Laundry Orders
                                        </a>
                                    @endif
                                @endauth
